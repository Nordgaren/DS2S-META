...
namespace Testing
{
    ...
    internal class DarkSouls1
    {
        ...
        {
            _darkSouls.BonfireWarp(WarpType.FirelinkShrineBonfire);
            Thread.Sleep(3000);
            
            _darkSouls.Teleport(new Vector3f(-43.0f, -31.0f, 101.0f), 180);
            Thread.Sleep(3000);
            _assistant.Interact();
            ...
            //Break the floor
            _darkSouls.Teleport(new Vector3f(3.0f, 198.0f, -22.0f), 180);
            Thread.Sleep(100);

            //Kill
            _darkSouls.Teleport(new Vector3f(5.0f, 182.0f, -12.0f), 0);
            Thread.Sleep(2000);
            _assistant.Punch();
        ...
        {
            _darkSouls.BonfireWarp(WarpType.DarkrootGardenBonfire);
            Thread.Sleep(3000);

            //Trigger fight
            _darkSouls.Teleport(new Vector3f(179.0f, 8.0f, 30.0f), 312);

            //boop her head
            Thread.Sleep(12000);
            _darkSouls.Teleport(new Vector3f(170.7f, 16.0f, 32.4f), 312);
            Thread.Sleep(1000);
            _darkSouls.Teleport(new Vector3f(179.0f, 8.0f, 30.0f), 312);
        ...
        private static void KillCapraDemon()
        {
            ...
            _darkSouls.Teleport(new Vector3f(-81.0f, -43.0f, -2.5f), 0); 
            Thread.Sleep(2000);
        ...
        private static void KillCeaselessDischarge()
        {
            ...
            _darkSouls.Teleport(new Vector3f(405.0f, -278.0f, 48.0f), 82);
            Thread.Sleep(2000);
        ...
        {
            _darkSouls.BonfireWarp(WarpType.DemonRuinsBonfire2);
            Thread.Sleep(3000);

            _darkSouls.Teleport(new Vector3f(119.0f, -341.0f, 127.0f), 317);
            Thread.Sleep(2000);
        ...
        {
            _darkSouls.BonfireWarp(WarpType.DemonRuinsBonfire3);
            Thread.Sleep(3000);

            //Trigger fight
            _darkSouls.Teleport(new Vector3f(167, -383.0f, 78.0f), 140);
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
            Thread.Sleep(1000);

            _darkSouls.Teleport(new Vector3f(203.2f, -383.7f, 49.5f), 9);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(8000);
        }
        ...
        {
            _darkSouls.BonfireWarp(WarpType.LostIzalithBonfire2);
            Thread.Sleep(3000);

            //kill right
            _darkSouls.Teleport(new Vector3f(572.8f, -440.13f, 421.1f), 4);
            Thread.Sleep(2000);
            _assistant.Punch(); 
            Thread.Sleep(1500);
            _assistant.SkipCutscene();
            ...
            //kill left
            _darkSouls.Teleport(new Vector3f(556.2f, -440.13f, 440.4f), 84);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(1500);
            _assistant.SkipCutscene();
            ...
            //Kill middle
            _darkSouls.Teleport(new Vector3f(581.4f, -444.0f, 445.0f), 14);
            Thread.Sleep(1500);
            _assistant.Punch();
            Thread.Sleep(6000);
        }
        ...
        {
            _darkSouls.BonfireWarp(WarpType.SensFortressBonfire);
            Thread.Sleep(3000);

            //trigger fight
            _darkSouls.Teleport(new Vector3f(84.0f, 82.0f, 255.5f), 90);
            Thread.Sleep(100);

            _darkSouls.Teleport(new Vector3f(123.7f, 82.0f, 255.5f), 90);
            Thread.Sleep(2000);
        ...
        private static void KillGwyndolin()
        {
            ...
            _darkSouls.Teleport(new Vector3f(479.0f, 30.0f, 255.0f), 90);
            Thread.Sleep(100);
            _assistant.Punch();
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
        ...
        {
            _darkSouls.BonfireWarp(WarpType.TheDukesArchivesBalconyBonfire);
            Thread.Sleep(3000);

            //Trigger fight
            _darkSouls.Teleport(new Vector3f(120.0f, 136.0f, 845.6f), 300);
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
            Thread.Sleep(100);

            //Kill crystal
            _darkSouls.Teleport(new Vector3f(86.0f, 134.5f, 872.4f), 295);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(1000);

            _darkSouls.Teleport(new Vector3f(120.0f, 134.0f, 842.0f), 300);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(1000);
        ...
        private static void KillSif()
        {
            ...
            //Trigger fight
            _darkSouls.Teleport(new Vector3f(253.3f, -16.0f, -320.0f), 20);
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
            Thread.Sleep(100);

            _darkSouls.Teleport(new Vector3f(261.8f, -17.0f, -299.2f), 25);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(3000);
        ...
        private static void KillFourKings()
        {
            ...
            if (!_darkSouls.IsBossDefeated(BossType.Sif))
            {
                KillSif();
            }

            _darkSouls.BonfireWarp(WarpType.AbyssBonfire);
            Thread.Sleep(3000);

            _darkSouls.Teleport(new Vector3f(13.3f, -311.0f, 8.0f), 273);
            Thread.Sleep(10000);
        ...
        {
            _darkSouls.BonfireWarp(WarpType.TomboftheGiantsEntrance);
            Thread.Sleep(3000);

            //Trigger fight
            _darkSouls.Teleport(new Vector3f(45.0f, -165.8f, 140.0f), 0);
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
            Thread.Sleep(100);

            _darkSouls.Teleport(new Vector3f(46.0f, -165.8f, 145.0f), 0);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(1000);
        ...
        {
            _darkSouls.BonfireWarp(WarpType.TomboftheGiantsBonfire2);
            Thread.Sleep(3000);

            //Trigger fight
            _darkSouls.Teleport(new Vector3f(-126.7f, -265.0f, -30.7f), 277);
            Thread.Sleep(1000);
            _assistant.SkipCutscene();
            Thread.Sleep(100);
        ...
        {
            _darkSouls.BonfireWarp(WarpType.OolacileSanctuaryBonfire); 
            Thread.Sleep(3000);

            //kill
            _darkSouls.Teleport(new Vector3f(964.0f, -320.9f, 512.4f), 158);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(5000);
        }
        ...
        {
            _darkSouls.BonfireWarp(WarpType.ChasmOfTheAbyssManus);
            Thread.Sleep(3000);

            _darkSouls.Teleport(new Vector3f(853.7f, -576.8f, 855.9f), 304);
            Thread.Sleep(2000);
            _assistant.Punch();
            Thread.Sleep(7000);
        }
        ...
        {
            _darkSouls.BonfireWarp(WarpType.KilnoftheFirstFlameGwyn);
            Thread.Sleep(3000);
